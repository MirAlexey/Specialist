...
// 
   ...
   MODULE_PARM_DESC(count, "Major device number");
...
//    int k; 
    ...
    {    
        ...
        AllDev = (struct meteo_group*) kmalloc(sizeof(struct _meteo_group)*count, GFP_KERMEL ) ;
        if(!AllDev){
...
END2:
    unregistred_chrdev(major, METEO_NAME);
